...
До того, как переписать .yaml-файл, вводим команду ip route, смотри дефолтный ip (10.0.2.2)
...
sudo usermod -aG adm,sudo user1 # добавляем user1 в группу adm и sudo
